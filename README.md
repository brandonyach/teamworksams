# teamworksams
A Python wrapper for the Teamworks AMS (Athlete Management System) API. <img src="assets/ams_logo.png" align="right" height="100" style="float:right; height:90px; width:90px">
