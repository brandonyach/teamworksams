...
def _validate_file_path(file_dir: str, file_names: List[str], function: str, is_avatar: bool = False, option: Optional[FileUploadOption] = None) -> Tuple[List[Tuple[Path, str]], List[Tuple[str, str]]]:
    ...
    valid_extensions = {'.png', '.jpg', '.jpeg'} if is_avatar else {'.pdf', '.doc', '.docx', '.txt', '.csv', '.png', '.jpg', '.jpeg', '.gif', '.heic', '.HEIC', '.xls', '.xlsx', '.tiff', '.tif', '.odt' '.mp4', '.MP4', '.mov' '.zip', '.ZIP', '.ppt', '.pptx', '.eml'}
    valid_files = []
    invalid_files = []
